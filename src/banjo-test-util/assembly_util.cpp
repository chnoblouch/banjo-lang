...
const std::unordered_map<std::string_view, mcode::Opcode> AARCH64_OPCODE_MAP = {
    ...
    {"lsr", target::AArch64Opcode::LSR},       {"asr", target::AArch64Opcode::ASR},
    {"csel", target::AArch64Opcode::CSEL},     {"fmov", target::AArch64Opcode::FMOV},
    {"fadd", target::AArch64Opcode::FADD},     {"fsub", target::AArch64Opcode::FSUB},
    {"fmul", target::AArch64Opcode::FMUL},     {"fdiv", target::AArch64Opcode::FDIV},
    {"fcvt", target::AArch64Opcode::FCVT},     {"scvtf", target::AArch64Opcode::SCVTF},
    {"ucvtf", target::AArch64Opcode::UCVTF},   {"fcvtzs", target::AArch64Opcode::FCVTZS},
    {"fcvtzu", target::AArch64Opcode::FCVTZU}, {"fcsel", target::AArch64Opcode::FCSEL},
    {"cmp", target::AArch64Opcode::CMP},       {"fcmp", target::AArch64Opcode::FCMP},
    {"b", target::AArch64Opcode::B},           {"br", target::AArch64Opcode::BR},
    {"b.eq", target::AArch64Opcode::B_EQ},     {"b.ne", target::AArch64Opcode::B_NE},
    {"b.hs", target::AArch64Opcode::B_HS},     {"b.lo", target::AArch64Opcode::B_LO},
    {"b.hi", target::AArch64Opcode::B_HI},     {"b.ls", target::AArch64Opcode::B_LS},
    {"b.ge", target::AArch64Opcode::B_GE},     {"b.lt", target::AArch64Opcode::B_LT},
    {"b.gt", target::AArch64Opcode::B_GT},     {"b.le", target::AArch64Opcode::B_LE},
    {"bl", target::AArch64Opcode::BL},         {"blr", target::AArch64Opcode::BLR},
    {"ret", target::AArch64Opcode::RET},       {"adrp", target::AArch64Opcode::ADRP},
    {"uxtb", target::AArch64Opcode::UXTB},     {"uxth", target::AArch64Opcode::UXTH},
    {"sxtb", target::AArch64Opcode::SXTB},     {"sxth", target::AArch64Opcode::SXTH},
