...
private:
    Result analyze_int_literal(sir::IntLiteral &int_literal, sir::Expr &out_expr);
    Result analyze_fp_literal(sir::FPLiteral &fp_literal, sir::Expr &out_expr);
    void analyze_bool_literal(sir::BoolLiteral &bool_literal);
    void analyze_char_literal(sir::CharLiteral &char_literal);
    Result analyze_null_literal(sir::NullLiteral &null_literal, sir::Expr &out_expr);
    Result analyze_none_literal(sir::NoneLiteral &none_literal, sir::Expr &out_expr);
