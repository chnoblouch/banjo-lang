...
void copy_val(IRBuilderContext &context, ir::Value src_ptr, ir::Value dest_ptr);
...
StoredValue build_call(FuncCall call, const StorageReqs &reqs, IRBuilderContext &context);
