...
bool X8664RegAnalyzer::is_reg_overridden(mcode::PhysicalReg reg, codegen::InstrContext &instr_ctx) {
...
std::vector<mcode::RegOp> X8664RegAnalyzer::get_operands(codegen::InstrContext &instr_ctx) {
