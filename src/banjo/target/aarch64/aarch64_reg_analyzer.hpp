...
public:
    static constexpr mcode::PhysicalReg SCRATCH_REGISTER = AArch64Register::R28;
...
public:
    ...
    void collect_successors(mcode::BasicBlockIter block, std::vector<mcode::BasicBlock *> &out_succs) override;
