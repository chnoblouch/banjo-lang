...
void WasmBuilder::encode_instr(FuncContext &ctx, mcode::Instruction &instr) {
    switch (instr.get_opcode()) {
        ...
        case target::WasmOpcode::F64_CONST:
            ...
            break;
        case target::WasmOpcode::I32_EQ: ctx.body.write_u8(0x46); break;
        case target::WasmOpcode::I32_NE: ctx.body.write_u8(0x47); break;
        case target::WasmOpcode::I32_LT_S: ctx.body.write_u8(0x48); break;
        case target::WasmOpcode::I32_LT_U: ctx.body.write_u8(0x49); break;
        case target::WasmOpcode::I32_GT_S: ctx.body.write_u8(0x4A); break;
        case target::WasmOpcode::I32_GT_U: ctx.body.write_u8(0x4B); break;
        case target::WasmOpcode::I32_LE_S: ctx.body.write_u8(0x4C); break;
        case target::WasmOpcode::I32_LE_U: ctx.body.write_u8(0x4D); break;
        case target::WasmOpcode::I32_GE_S: ctx.body.write_u8(0x4E); break;
        case target::WasmOpcode::I32_GE_U: ctx.body.write_u8(0x4F); break;
        case target::WasmOpcode::I64_EQ: ctx.body.write_u8(0x51); break;
        case target::WasmOpcode::I64_NE: ctx.body.write_u8(0x52); break;
        case target::WasmOpcode::I64_LT_S: ctx.body.write_u8(0x53); break;
        case target::WasmOpcode::I64_LT_U: ctx.body.write_u8(0x54); break;
        case target::WasmOpcode::I64_GT_S: ctx.body.write_u8(0x55); break;
        case target::WasmOpcode::I64_GT_U: ctx.body.write_u8(0x56); break;
        case target::WasmOpcode::I64_LE_S: ctx.body.write_u8(0x57); break;
        case target::WasmOpcode::I64_LE_U: ctx.body.write_u8(0x58); break;
        case target::WasmOpcode::I64_GE_S: ctx.body.write_u8(0x59); break;
        case target::WasmOpcode::I64_GE_U: ctx.body.write_u8(0x5A); break;
        case target::WasmOpcode::F32_EQ: ctx.body.write_u8(0x5B); break;
        case target::WasmOpcode::F32_NE: ctx.body.write_u8(0x5C); break;
        case target::WasmOpcode::F32_LT: ctx.body.write_u8(0x5D); break;
        case target::WasmOpcode::F32_GT: ctx.body.write_u8(0x5E); break;
        case target::WasmOpcode::F32_LE: ctx.body.write_u8(0x5F); break;
        case target::WasmOpcode::F32_GE: ctx.body.write_u8(0x60); break;
        case target::WasmOpcode::F64_EQ: ctx.body.write_u8(0x61); break;
        case target::WasmOpcode::F64_NE: ctx.body.write_u8(0x62); break;
        case target::WasmOpcode::F64_LT: ctx.body.write_u8(0x63); break;
        case target::WasmOpcode::F64_GT: ctx.body.write_u8(0x64); break;
        case target::WasmOpcode::F64_LE: ctx.body.write_u8(0x65); break;
        case target::WasmOpcode::F64_GE: ctx.body.write_u8(0x66); break;
