...
sir::Expr create_primitive_type(sir::Module &mod, sir::Primitive primitive) {
    return mod.create(sir::PrimitiveType{
        .ast_node = nullptr,
        .primitive = primitive,
    });
}
...
sir::Expr create_call(sir::Module &mod, sir::FuncDef &func_def, std::span<sir::Expr> args) {
    return mod.create(sir::CallExpr{
        .ast_node = nullptr,
        .type = func_def.type.return_type,
        .callee = mod.create(sir::SymbolExpr{
            .ast_node = nullptr,
            .type = &func_def.type,
            .symbol = &func_def,
        }),
...
sir::Expr create_unary_ref(sir::Module &mod, sir::Expr base_value) {
    return mod.create(sir::UnaryExpr{
        .ast_node = nullptr,
        .type = mod.create(sir::PointerType{
            .ast_node = nullptr,
